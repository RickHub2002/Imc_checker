function start() {
    ...
    inputHeight.addEventListener("input", function () {
        ...
        // Garantir que sempre começa com '1'
        if (value.length === 0) {
        ...
        if (value.length >= 2) {
            this.value = "1" + "." + value.slice(1); // Coloca o "1" fixo no início e o ponto após o primeiro dígito
        } else {
            this.value = "1" + value; // Caso contrário, coloca o "1" fixo no início e os outros números
        }
    });
